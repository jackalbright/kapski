...
<div id="galleria">
    <div class="image">
            <img src="images/galleryImages/image1.jpg" alt="Kapski painting image gallery image 1" title="Kapski Painting">
           <h2>Image 1 title</h2>
            <div class="desc">Image 1 <strong>strong</strong> tags or any other HTML as caption</div>
    </div>
     <div class="image">
            <img src="images/galleryImages/image2.jpg" alt="Kapski painting image gallery image 2" title="Kapski Painting">
           <h2>Image 2 title</h2>
            <div class="desc">Image 1 <strong>strong</strong> tags or any other HTML as caption</div>
    </div>
     <div class="image">
            <img src="images/galleryImages/image3.jpg" alt="Kapski painting image gallery image 3" title="Kapski Painting">
           <h2>Image 3 title</h2>
            <div class="desc">Image 1 <strong>strong</strong> tags or any other HTML as caption</div>
    </div>
</div>
...
<script type="text/javascript" src="js/galleria/galleria-1.3.1.min.js" ></script>
...
alert("document ready");
  if (Galleria) { 
	...
	Galleria.run('#galleria',{
        ...
        return {
            title: jQuery(".image").next('h2').html(),
    		description: jQuery(".image").siblings(".desc").html() 
        };
    }
});
